...
public class Search_Type extends GerpTop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.retrieval.Search");
  ...
  public String getQuery(int addr) {
      ...
      jcas.throwFeatMissing("query", "org.oaqa.model.retrieval.Search");
  ...
  public int getHitList(int addr) {
      ...
      jcas.throwFeatMissing("hitList", "org.oaqa.model.retrieval.Search");
  ...
  public int getAbstractQuery(int addr) {
      ...
      jcas.throwFeatMissing("abstractQuery", "org.oaqa.model.retrieval.Search");
  ...
  public String getSearchId(int addr) {
      ...
      jcas.throwFeatMissing("searchId", "org.oaqa.model.retrieval.Search");
  ...
  public Search_Type(JCas jcas, Type casType) {
    ...
    casFeat_abstractQuery = jcas.getRequiredFeatureDE(casType, "abstractQuery", "org.oaqa.model.retrieval.AbstractQuery", featOkTst);
