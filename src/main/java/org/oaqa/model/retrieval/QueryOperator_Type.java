...
public class QueryOperator_Type extends GerpTop_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.retrieval.QueryOperator");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "org.oaqa.model.retrieval.QueryOperator");
  ...
  public int getArgs(int addr) {
      ...
      jcas.throwFeatMissing("args", "org.oaqa.model.retrieval.QueryOperator");
  ...
  public QueryOperator_Type(JCas jcas, Type casType) {
    ...
    casFeat_name = jcas.getRequiredFeatureDE(casType, "name", "org.oaqa.model.retrieval.QueryOperatorName", featOkTst);
