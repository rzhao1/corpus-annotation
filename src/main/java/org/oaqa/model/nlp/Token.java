...
public class Token extends GerpAnnotation {
  ...
  public FSList getLemmaEntries() {
    if (Token_Type.featOkTst && ((Token_Type)jcasType).casFeat_lemmaEntries == null)
      jcasType.jcas.throwFeatMissing("lemmaEntries", "org.oaqa.model.nlp.Token");
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Token_Type)jcasType).casFeatCode_lemmaEntries)));}
  ...
  public void setLemmaEntries(FSList v) {
    if (Token_Type.featOkTst && ((Token_Type)jcasType).casFeat_lemmaEntries == null)
      jcasType.jcas.throwFeatMissing("lemmaEntries", "org.oaqa.model.nlp.Token");
    jcasType.ll_cas.ll_setRefValue(addr, ((Token_Type)jcasType).casFeatCode_lemmaEntries, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getTokenType() {
    if (Token_Type.featOkTst && ((Token_Type)jcasType).casFeat_tokenType == null)
      jcasType.jcas.throwFeatMissing("tokenType", "org.oaqa.model.nlp.Token");
