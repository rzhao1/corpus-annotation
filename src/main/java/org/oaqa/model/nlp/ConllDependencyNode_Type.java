 ...
 * @generated */
public class ConllDependencyNode_Type extends GerpAnnotation_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public int getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getForm(int addr) {
      ...
      jcas.throwFeatMissing("form", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getLemma(int addr) {
      ...
      jcas.throwFeatMissing("lemma", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getCpostag(int addr) {
      ...
      jcas.throwFeatMissing("cpostag", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getPostag(int addr) {
      ...
      jcas.throwFeatMissing("postag", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getFeats(int addr) {
      ...
      jcas.throwFeatMissing("feats", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public int getHead(int addr) {
      ...
      jcas.throwFeatMissing("head", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getDeprel(int addr) {
      ...
      jcas.throwFeatMissing("deprel", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public int getPhead(int addr) {
      ...
      jcas.throwFeatMissing("phead", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public String getPdeprel(int addr) {
      ...
      jcas.throwFeatMissing("pdeprel", "org.oaqa.model.nlp.ConllDependencyNode");
  ...
  public ConllDependencyNode_Type(JCas jcas, Type casType) {
    ...
    casFeat_head = jcas.getRequiredFeatureDE(casType, "head", "org.oaqa.model.nlp.ConllDependencyNode", featOkTst);
    ...
    casFeat_phead = jcas.getRequiredFeatureDE(casType, "phead", "org.oaqa.model.nlp.ConllDependencyNode", featOkTst);
