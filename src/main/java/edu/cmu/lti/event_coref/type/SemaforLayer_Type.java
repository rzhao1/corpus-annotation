 ...
 * @generated */
public class SemaforLayer_Type extends GerpAnnotation_Type {
  /** @generated */
  @Override
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.event_coref.type.SemaforLayer");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "edu.cmu.lti.event_coref.type.SemaforLayer");
  ...
  public int getLabels(int addr) {
      ...
      jcas.throwFeatMissing("labels", "edu.cmu.lti.event_coref.type.SemaforLayer");
  ...
  public int getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "edu.cmu.lti.event_coref.type.SemaforLayer");
