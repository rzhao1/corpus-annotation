...
public abstract class DependencyUtility {
  ...
  public static Logger logger = Logger
          .getLogger("edu.cmu.lti.oaqa.corpus_annotation.gerpphase.core.DependencyUtility");

  public static void addToIndexes(JCas jcas, ArrayList<ConllDependencyNode> nodes) {
    for (int i = 0; i < nodes.size(); i++) {
      // Enter UIMA nodes into index
      if (nodes.get(i).getGenerators() == null) {
        NonEmptyStringList generator = new NonEmptyStringList(jcas);
        nodes.get(i).setGenerators(generator);
        generator.setHead("Clear Parser");
      } else {
        NonEmptyStringList generator = (NonEmptyStringList) nodes.get(i).getGenerators();
  ...
  public static DependencyPath getPath(List<ConllDependencyNode> nodes, ConllDependencyNode node1,
  ...
  public static DependencyPath getPath(JCas jCas, ConllDependencyNode node1,
          ConllDependencyNode node2) {
  ...
  public static List<ConllDependencyNode> getRightSibs(ConllDependencyNode refNode,
  ...
  public static List<ConllDependencyNode> getLeftSibs(ConllDependencyNode refNode,
          List<ConllDependencyNode> tree) {
  ...
  public static List<ConllDependencyNode> getProgeny(ConllDependencyNode refNode,
          List<ConllDependencyNode> tree) {
  ...
  public static List<ConllDependencyNode> getProgeny(List<ConllDependencyNode> refNodes,
          List<ConllDependencyNode> tree) {
  ...
  public static List<ConllDependencyNode> getRightSibProgeny(ConllDependencyNode refNode,
          List<ConllDependencyNode> tree) {
    return getProgeny(getRightSibs(refNode, tree), tree);
  }

  public static List<ConllDependencyNode> getLeftSibProgeny(ConllDependencyNode refNode,
          List<ConllDependencyNode> tree) {
  ...
  public static String dumpDependencyGraph(Annotation annotation) {
    ...
    for (ConllDependencyNode depNode : JCasUtil
            .selectCovered(ConllDependencyNode.class, annotation)) {
      ConllDependencyNode head = depNode.getHead();
      String headStr = (head != null) ? head.getCoveredText() : "TOP";
      builder.append(String.format("%s(%s, %s)\n", depNode.getDeprel(), depNode.getCoveredText(),
              headStr));
    }
