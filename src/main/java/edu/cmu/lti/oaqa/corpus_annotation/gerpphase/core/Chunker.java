...
public class Chunker extends JCasAnnotator_ImplBase {
  ...
  /**
   * "ChunkerModel" is a required, single, string parameter that contains the file name of the
   * chunker model. The model file name should end with ".bin.gz" or ".txt". If this is not the
   * case, then please see resources/models/README.
   */
  public static final String CHUNKER_MODEL_FILE_PARAM = "ChunkerModelFile";

  /**
   * "ChunkCreatorClass" is a required, single, string parameter that specifies the chunker creator
   * class to instantiate. A chunker creator determines how chunk annotations are created.
   * 
   * @see ChunkCreator
